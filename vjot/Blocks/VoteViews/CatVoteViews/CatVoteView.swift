    ...
    var body: some View {
        ZStack {
            ScrollView {
                ...
                CatImageView(image: image, deleted: .constant(false))
                    .padding()
                        ...
                        do {
                                ...
                                if let currentId = veterinarianGig.currentId {
                                    if var currentVet = veterinarianGig.track(currentId: currentId) {
                                        ...
                                        currentVet.catVotes[image.id] = self.voteId
                ...
                if voted {
                    ...
                    Button {
                        Task {
                            do {
                                if let vote {
                                    try await _ = voteEngine.deleteCat(voteId: vote.id)
                                    ...
                                    if let currentId = veterinarianGig.currentId {
                                        if var currentVet = veterinarianGig.track(currentId: currentId) {
                                            currentVet.catVotes[image.id] = nil
                                            try veterinarianGig.update(veterinarian: currentVet)
                                        }
                                    }
