...
struct CatImageFavListView: View {
        ...
        ZStack {
            ...
            if !loaded {
                ...
                if noFavs {
                    ...
                    FavFallbackView(forSpecies: .forCats, forCurrent: true)
                        ...
                        if let favs = dict[currentId] {
                            ...
                            List {
                                ...
                                ForEach(favs, id: \.id) { fav in
                                    ...
                                    NavigationLink {
                                        CatImageFavListElementContentView(favourite: fav, veterinarianId: currentId)
                                    } label: {
                                        CatImageFavListElementView(favourite: fav)
                                    }
                                }
                            }
...
struct CatImageFavListElementView: View {
...
struct CatImageFavListElementContentView: View {
    var favourite: CatAPIFavourite
