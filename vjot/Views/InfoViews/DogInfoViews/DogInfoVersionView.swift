...
struct DogInfoVersionView: View {
    ...
    var body: some View {
        ...
        .toolbar {
            ToolbarItem(placement: .navigationBarTrailing) {
                Button {
                    ...
                    Label("BACK TO DOGS", systemImage: "gearshape.2")
                }
            }
        }
        ...
        .task {
            do {
                version = try await versionEngine.fetch(api: .forDogs)
...
//struct DogInfoVersionView_Previews: PreviewProvider {
