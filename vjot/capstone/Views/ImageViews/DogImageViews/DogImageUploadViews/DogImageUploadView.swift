...
struct DogImageUploadView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .sheet(isPresented: $uploaded, onDismiss: {
                ...
                if let image {
                    if let status {
                        DogImageUploadStatusView(image: image, status: status, uploaded: $uploaded)
                    }
                }
            })
...
struct DogImageUploadStatusView: View {
    var image: Image
...
//struct DogImageUploadView_Previews: PreviewProvider {
