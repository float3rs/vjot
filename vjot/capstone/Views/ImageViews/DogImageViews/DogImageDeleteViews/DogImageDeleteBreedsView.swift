//
//  DogImageDeleteBreedsView.swift
//  Saridakis-vjot
//
...
struct DogImageDeleteBreedsView: View {
...
struct DogImageDeleteBreedsListView: View {
                ...
                if searchState == 0 {
                    ForEach(breedEngine.searchDogs()) { dogBreed in
                        NavigationLink {
                            ...
                            DogImageDeleteBreedsListElementView(dogBreed: dogBreed)
                        }
                        ...
                        .swipeActions(edge: .leading, allowsFullSwipe: true, content: {
                            Button {
                                imageEngine.uploadedDogBreedIds.append(dogBreed.id)
                            } label: {
                        ...
                        .swipeActions(edge: .trailing, allowsFullSwipe: true, content: {
                            Button {
                                imageEngine.uploadedDogBreedIds = imageEngine.uploadedDogBreedIds.filter { $0 != dogBreed.id }
                            } label: {
...
struct DogImageDeleteBreedsListElementView: View {
    ...
    var body: some View {
        HStack {
            Spacer()
            Text(dogBreed.name)
                .foregroundColor(imageEngine.uploadedDogBreedIds.contains(where: {$0 == dogBreed.id}) ? Color.accentColor : Color.secondary)
        }
    }
}
...
//struct DogImageDeleteBreedsView_Previews: PreviewProvider {
