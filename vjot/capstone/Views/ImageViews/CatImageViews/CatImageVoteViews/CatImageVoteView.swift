...
struct CatImageVoteView: View {
    var body: some View {
        CatImageVoteListView()
    }
}
...
struct CatImageVoteListView: View {
    
    @State var votes: [CatAPIVote] = []
    @State var dict: [UUID: [CatAPIVote]] = [:]
    
//    @State var notCurrent: Bool = false
        ...
        ZStack {
            ...
            if !loaded {
                ...
                if noVotes {
                    ...
                    VoteFallbackView(forSpecies: .forCats, forCurrent: true)
                        ...
                        if let votes = dict[currentId] {
                            ...
                            List {
                                ...
                                ForEach(votes, id: \.id) { vote in
                                    ...
                                    NavigationLink {
                                        CatImageVoteListElementContentView(vote: vote, veterinarianId: currentId)
                                    } label: {
                                        CatImageVoteListElementView(vote: vote)
                                    }
                                }
                            }
...
struct CatImageVoteListElementView: View {
    var vote: CatAPIVote
...
struct CatImageVoteListElementContentView: View {
    var vote: CatAPIVote
...
//struct CatImageVoteView_Previews: PreviewProvider {
