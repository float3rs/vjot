...
struct CatImageFavFindView: View {
    ...
    @State var favourite: CatAPIFavourite? = nil
        ...
        VStack {
            ...
            ScrollView {
                    ...
                    Task {
                        do {
                            ...
                            if let favouriteId = Int(favouriteId) {
                                favourite = try await favouriteEngine.fetchCat(favouriteId: favouriteId)
                            }
                ...
                if !noResult {
                    ...
                    if let favourite { CatFavDetailsView(favourite: favourite) }
                }
...
//struct CatImageFavFindView_Previews: PreviewProvider {
