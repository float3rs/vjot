...
struct DogAnalysisView: View {
    ...
    var body: some View {
        ...
        .task {
            do {
                try await analysisEngine.fetch(.forDogs, imageId: image.id)
            } catch let error {
...
//struct DogAnalysisView_Previews: PreviewProvider {
