...
struct CatDeleteButtonView: View {
...
//                    .padding(.bottom)
        ...
        .confirmationDialog("(◡︵◡)", isPresented: $goDelete, actions: {
            ...
            Text("The cat will no longer be available; any favs and/or votes associated with it will also be permanently removed; this action cannot be undone.")
//            HStack(spacing: 0) {
...
//            }
    ...
    func delete(imageId: String) async throws {
        ...
        try await imageEngine.delete(.forCats, imageId: imageId)
        try veterinarianGig.cleanCat(imageId: imageId)
        deleted = true
    }
}
...
//struct CatDeleteView_Previews: PreviewProvider {
