//
//  FoldedCatAPICategoryModel.swift
//  Saridakis-vjot
//
...
// MARK: CATS' CATEGORIES (DECODING)
// The IDs of the categories to filter the images.

struct FoldedCatAPICategory {
    var id: Int
    var name: String
}
...
extension FoldedCatAPICategory: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        do {
            ...
            report(error: error, decoding: "FoldedCatAPICategory.id")
            throw error
        }
        do {
            name = try container.decode(String.self, forKey: .name)
        } catch(let error) {
            report(error: error, decoding: "FoldedCatAPICategory.name")
            throw(error)
        }
    }
}
...
func decodeCatAPICategories(data: Data) throws -> [FoldedCatAPICategory] {
    let jsonData = data
    let decoder = JSONDecoder()
    
    let foldedCatAPIBreeds = try decoder.decode([FoldedCatAPICategory].self, from: jsonData)
